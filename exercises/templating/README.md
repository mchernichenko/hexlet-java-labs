...
* [Примеры оформления таблиц Bootstrap](https://bootstrap-4.ru/docs/4.0/content/tables/)
...
* [Про JSTL на tutorialspoint](https://www.tutorialspoint.com/jsp/jsp_standard_tag_library.htm)
* [Про JSTL на javatpoint](https://www.javatpoint.com/jstl)
* [Пример работы с библиотекой JSTL](https://www.baeldung.com/jstl)
* [**letsCode**: JSTL для JSP (Java Servlet)](https://www.youtube.com/watch?v=eIXoxMj2tS8&list=PLU2ftbIeotGoQGD51e0qb98lE0xhgNDF1&index=4)
* [**letsCode**: git](https://github.com/drucoder/servlet/tree/JSTL/src/main/webapp)
...
* В методе `showUsers()` реализуйте передачу управления в jsp-файл */index.jsp*. Для того, чтобы предать данные пользователей в jsp-файл, вам потребуется установить атрибуты запроса при помощи метода `setAttribute()`.
