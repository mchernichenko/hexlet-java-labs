...
public class SessionServlet extends HttpServlet {
    ...
    private void login(HttpServletRequest request,
        ...
        // BEGIN
        LOGGER.log(Level.INFO,"Поступил запрос на авторизацию пользователя email: " + email );
        // END
        ...
        if (user == null || !user.get("password").equals(password)) {
            ...
            TemplateEngineUtil.render("session/login.html", request, response);
            LOGGER.log(Level.INFO, "Неуспешная авторизация пользователя с email: " + email);
            return;
        }
        ...
        LOGGER.log(Level.INFO, "Успешная авторизация пользователя с email: " + email);
    }
