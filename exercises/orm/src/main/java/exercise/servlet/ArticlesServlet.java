...
public class ArticlesServlet extends HttpServlet {
    ...
    private void showArticles(HttpServletRequest request,
        ...
        PagedList<Article> pagedArticles = new QArticle()
                .setFirstRow(offset)          // Устанавливаем смещение
                .setMaxRows(articlesPerPage)  // Устанавливаем максимальное количество записей в результате
                .orderBy().id.asc() // Задаём сортировку по id
                .findPagedList();   // Получаем список PagedList, который представляет одну страницу результата
