...
public class AppTest {
    ...
    // BEGIN
    @Test
    void testFilterUsersByAllParam() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(get("/users/v2/?lastName=sTupena&firstName=tha&email=rastupenas&profession=Electrical Engineer"))
                .andReturn()
                .getResponse();
        ...
        assertThat(actualUser.getEmail()).isEqualTo("rastupenas0@mysql.com");
