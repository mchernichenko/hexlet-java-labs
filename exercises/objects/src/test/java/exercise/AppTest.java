...
class AppTest {
    ...
    void testGetYoungestUser() {
        ...
        String actual1 = App.getYoungestUser(users1, "11 Jul 1989");
        String expected1 = "John Smith";
        assertThat(actual1).isEqualTo(expected1);

        String actual2 = App.getYoungestUser(users1, "11 Jul 1980");
        String expected2 = "";
        assertThat(actual2).isEqualTo(expected2);

        String[][] users3 = {};
        String expected3 = "";
        String actual3 = App.getYoungestUser(users3, "11 Jul 1989");
