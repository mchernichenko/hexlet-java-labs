...
public final class ArticleController {
    ...
    public static Handler editArticle = ctx -> { // GET /articles/{id}/edit
        // BEGIN
        long id = ctx.pathParamAsClass("id", Long.class).getOrDefault(null);
        Article article = new QArticle()
                .id.equalTo(id)
    ...
    public static Handler updateArticle = ctx -> {  // POST /articles/{id}/edit
        // BEGIN
        long id = ctx.pathParamAsClass("id", Long.class).getOrDefault(null);
        String title = ctx.formParam("title");
        String body = ctx.formParam("body");
    ...
    public static Handler deleteArticle = ctx -> { // GET /articles/{id}/delete
        // BEGIN
        long id = ctx.pathParamAsClass("id", Long.class).getOrDefault(null);
        Article article = new QArticle()
                .id.equalTo(id)
    ...
    public static Handler destroyArticle = ctx -> { // POST /articles/{id}/delete
        // BEGIN
        long id = ctx.pathParamAsClass("id", Long.class).getOrDefault(null);
